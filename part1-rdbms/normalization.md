...
While a single flat table might seem simpler for a small dataset, it is not over-engineering; it is a necessity for data integrity. Using our _orders_flat.csv_ as evidence, I strongly refute the position that a single table is sufficient for a growing business.
